...
export default function CatchPage() {
  return (
    <main className="min-h-screen bg-gradient-to-b from-cyan-50 via-pink-50 to-white">
      <CursorHearts />
      ...
      <div className="sticky top-0 z-40 bg-white/80 backdrop-blur border-b border-pink-200">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <h1 className="font-playfair text-3xl font-bold text-cyan-600">Catch Hearts</h1>
          <div className="w-16" />
        </div>
      </div>

      <div className="py-12 px-4 flex items-center justify-center min-h-[calc(100vh-120px)]">
        <CatchHearts isModal={false} />
      </div>
    </main>
  )
}
