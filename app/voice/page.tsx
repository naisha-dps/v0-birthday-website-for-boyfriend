...
export default function VoicePage() {
  return (
    <main className="min-h-screen bg-gradient-to-b from-amber-50 via-pink-50 to-white">
      <CursorHearts />
      ...
      <div className="sticky top-0 z-40 bg-white/80 backdrop-blur border-b border-pink-200">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <h1 className="font-playfair text-3xl font-bold text-amber-600">Voice Notes</h1>
          <div className="w-16" />
        </div>
      </div>

      <div className="py-12 px-4">
        <VoiceNotes isModal={false} />
      </div>
    </main>
  )
}
